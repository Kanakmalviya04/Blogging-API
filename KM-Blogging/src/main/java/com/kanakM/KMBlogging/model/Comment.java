package com.kanakM.KMBlogging.model;
...
public class Comment {
    ...
    public Post getInstaPost() {
        return new Post(instapost.getPostId(), instapost.getPostContent(), instapost.getPostCreatedTimeStamp(), instapost.getPostOwner());
    }
}
